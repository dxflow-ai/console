<template>
    <div class="px-1">
        ...
        <template v-if="expanded">
            <button
                type="button"
                class="flex w-full items-center gap-1.5 rounded-sm py-1.5 pr-2 pl-8 text-xs hover:bg-elevated"
                @click="open('diagram')"
            >
            ...
            <template v-if="stepsExpanded">
                <template v-for="step in steps" :key="step.identity">
                    <button
                        type="button"
                        class="flex w-full items-center gap-1.5 rounded-sm py-1.5 pr-2 pl-14 text-xs hover:bg-elevated"
